...
imgBird = pygame.image.load('images/birds.png')
imgPT = pygame.image.load('images/verh.png')
imgPB = pygame.image.load('images/niz.png')
...
bges.append(pygame.Rect(0, 0, 290, 600))
...
while play:
    ...
    image = imgBird.subsurface(27 * int(frame), 0, 27, 20)
    image = pygame.transform.rotate(image, -sy * 1.5)
